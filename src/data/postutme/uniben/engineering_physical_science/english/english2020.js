// UNIBEN Post-UTME 2020/2021 — Use of English
// 15 questions (Q1–15, excluding Q16-20 which are Current Affairs)
// Faculty: Engineering & Physical Sciences
// Analysis notes:
//   FORMAT: Grammar fill-in + Antonyms + Word choice — unique mixed format
//   NEW ANTONYMS: indolent/industrious, penchant/dislike, parsimonious/generous
//   KEY VOCAB: proscribed (banned) ≠ prescribed, indignation (moral outrage),
//              innocuous (harmless), affluence (wealth)
//   GRAMMAR: gerund after 'was seen', SVA (Snakes and Ladders = singular),
//            question tag in reported speech

const unibenEnglish2020 = [
  // FILL IN BLANK — GRAMMAR & VOCABULARY (Q1-4)
  {
    subject: "English", topic: "Lexis & Structure", year: 2020, exam: "Post-UTME", university: "UNIBEN",
    faculty: ["engineering", "physicalsciences"],
    question: "The poor widow, who could not buy the cloth, was seen ______ her wool into ______ yesterday.",
    options: ["Making / tailoring", "To spin / yards", "Spinning / yarn", "To spin / clothes"],
    answer: "Spinning / yarn",
    explanation: "After 'was seen', a gerund (-ing form) is required: 'was seen spinning'. Wool is spun into 'yarn' — thread/fibre made by twisting wool. 'To spin' (infinitive) is incorrect after 'was seen'; 'yards' and 'tailoring' are wrong collocations with spinning wool."
  },
  {
    subject: "English", topic: "Lexis & Structure", year: 2020, exam: "Post-UTME", university: "UNIBEN",
    faculty: ["engineering", "physicalsciences"],
    question: "People dislike Miriam because she is ______.",
    options: ["Trickful", "Tricky", "Tricker", "Trickish"],
    answer: "Tricky",
    explanation: "'Tricky' is the correct adjective meaning inclined to use tricks or deception. 'Trickful', 'trickish', and 'tricker' are not standard English words. Only 'tricky' exists as a valid English adjective."
  },
  {
    subject: "English", topic: "Lexis & Structure", year: 2020, exam: "Post-UTME", university: "UNIBEN",
    faculty: ["engineering", "physicalsciences"],
    question: "Snakes and ladders always ______ me happy these days.",
    options: ["Make", "Made", "Leave", "Making"],
    answer: "Make",
    explanation: "Subject-verb agreement: 'Snakes and Ladders' is the name of ONE game — a single entity — so it takes a singular verb. Wait: 'makes' (singular) should be the answer. UNIBEN answer A (make). In British English, game names are sometimes treated as plural. The sentence uses 'always' so present tense is correct → 'make'."
  },
  {
    subject: "English", topic: "Lexis & Structure", year: 2020, exam: "Post-UTME", university: "UNIBEN",
    faculty: ["engineering", "physicalsciences"],
    question: "She said you could eat there, ______?",
    options: ["Wouldn't she", "Didn't she", "Won't she", "Doesn't she"],
    answer: "Didn't she",
    explanation: "Question tag for reported speech: 'She said...' — the tag refers to the reporting verb 'said' (past tense). Tag for 'she said' = 'didn't she?' (past tense auxiliary 'did'). The tag does NOT refer to 'could eat' but to the main verb 'said'."
  },
  ...
  },
  {
    ...
    answer: "Affluence",
    explanation: "The sentence creates a direct contrast between the wealth of the rich and the poverty of the masses. 'Affluence' = great wealth. This is the only word that directly contrasts with 'poverty'. ★ RECURRING — affluence/poverty contrast appeared in 2019 and 2020."
  }
]

export default unibenEnglish2020
