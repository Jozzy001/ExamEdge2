...
const jamb2011 = [
  ...
  // =====================
  {
    ...
    questions: [
      ...
      },
      {
        ...
        explanation: "Wait — 'repercussions' IS the word being described here. The gap word preceding it is from the options: the answer is 'A. repercussions'. Threatening repercussions = serious negative consequences."
      },
      {
        topic: "Lexis & Structure",
        year: 2011,
  ...
  // =====================
  {
    ...
    explanation: "The second conditional 'if he were here' implies he is NOT here. The consequence is that the occasion has less fun than it could have had — he didn't show up and fun was lacking."
  },
  {
    topic: "Sentence Interpretation",
    year: 2011,
    ...
    explanation: "'Postponement' means shifting to a later date (not cancelling). 'Unforeseen circumstances' means unexpected reasons. Option A captures both elements correctly."
  },
  {
    topic: "Sentence Interpretation",
    year: 2011,
  ...
  },
  {
    ...
    explanation: "'More haste, less speed' is a proverb meaning that rushing leads to mistakes — so doing things carefully (not hurriedly) gets better results."
  },
  {
    topic: "Sentence Interpretation",
    year: 2011,
  ...
  },
  {
    ...
    explanation: "Note: JAMB's answer key gives B here. However, 'took a hit' idiomatically means suffered a setback or loss. This appears to be a JAMB answer key error — the literal meaning of the idiom points to option C, but the official answer is B."
  },
  {
    topic: "Sentence Interpretation",
    year: 2011,
  ...
  },
  {
    ...
    answer: "All the times I went to the village I also visited the king",
    explanation: "This is a habitual/conditional past. 'If I went... I would visit' describes a regular pattern — whenever I went to the village, I would visit the king."
  },
  ...
  },
  {
    ...
    answer: "praises",
    explanation: "'Compliments' means to express admiration or praise. 'Praises' is its direct synonym. Note: 'complements' (with an 'e') means to complete or enhance — a different word."
  },
  {
    topic: "Synonyms",
    year: 2011,
  ...
  },
  {
    ...
    answer: "iron",
    explanation: "'Corrugated' sheets in Nigerian context refers specifically to corrugated iron sheets — the term 'iron' is used colloquially to describe this roofing material."
  },
  {
    topic: "Synonyms",
    year: 2011,
  ...
  },
  {
    ...
    answer: "discreet",
    explanation: "'Tactful' means having the ability to deal with sensitive situations without offending people. 'Discreet' — careful and prudent in speech — is its closest synonym."
  },
  {
    topic: "Synonyms",
    year: 2011,
  ...
  },
  {
    ...
    explanation: "'Callow' means inexperienced and immature. Its opposite is 'experienced' — having knowledge and skill gained through time."
  },
  {
    topic: "Antonyms",
    year: 2011,
  ...
  // =====================
  {
    ...
    answer: "burst",
    explanation: "'Burst' is both the present and past tense form — it is an irregular verb. 'Bursted' does not exist. Since the sentence is in simple past narrative, 'burst' is correct."
  },
  {
    topic: "Lexis & Structure",
    year: 2011,
    ...
    answer: "used to work",
    explanation: "'Used to work' expresses a past habit or state that no longer exists — perfect for describing what someone did in their youth that they no longer do."
  },
  {
    topic: "Lexis & Structure",
    year: 2011,
    ...
    answer: "whenever",
    explanation: "'Whenever' introduces a conditional time clause meaning 'every time that' — fitting the habitual nature of the statement: every time the light is switched on, shadows disappear."
  },
  {
    topic: "Lexis & Structure",
    year: 2011,
    ...
    answer: "fortnight",
    explanation: "'Fortnight' means a period of two weeks. It is correctly spelled 'fortnight' — all other options are misspellings."
  },
  {
    topic: "Lexis & Structure",
    year: 2011,
    ...
    explanation: "'Ferreted about' means searched around in a suspicious or furtive manner. The phrasal verb 'ferret about/around' means to search thoroughly and nosily."
  },
  {
    topic: "Lexis & Structure",
    year: 2011,
    ...
    answer: "does she",
    explanation: "The question tag for 'needn't' (when used as a main verb without 'do') should use 'need she'. However, JAMB's answer key gives 'does she' — treating 'need' as a regular verb."
  },
  {
    topic: "Lexis & Structure",
    year: 2011,
    ...
    answer: "scoured",
    explanation: "'Scoured' means searched thoroughly. 'Scourged' means whipped or punished. 'Scoured the house' is the correct idiom for a thorough search."
  },
  {
    topic: "Lexis & Structure",
    year: 2011,
    ...
    explanation: "In reported speech, the present tense shifts to past: 'what time is it' becomes 'what time it was'. The word order also changes to statement order (subject before verb)."
  },
  {
    topic: "Lexis & Structure",
    year: 2011,
    ...
    answer: "eclectic",
    explanation: "'Eclectic' means deriving ideas or style from a broad range of sources. It is correctly spelled 'eclectic' — all other options are misspellings."
  },
  {
    topic: "Lexis & Structure",
    year: 2011,
    ...
    explanation: "'In furtherance of' is the correct preposition phrase meaning for the purpose of advancing something. 'Furtherance' collocates with 'in' and 'of'."
  },
  {
    topic: "Lexis & Structure",
    year: 2011,
    ...
    explanation: "'Pronunciation' is the correct spelling. A common error is adding an extra 'o' to make 'pronounciation' — the verb is 'pronounce' but the noun is 'pronunciation'."
  },
  {
    topic: "Lexis & Structure",
    year: 2011,
    ...
    answer: "pleading",
    explanation: "'Instead of' is a preposition and must be followed by a gerund (verb + -ing). 'Instead of pleading' is the correct form."
  },
  {
    topic: "Lexis & Structure",
    year: 2011,
    ...
    answer: "naughtiest",
    explanation: "When comparing three or more, the superlative form is used. 'Naughtiest' is the superlative of 'naughty'. 'Most notorious' would also work but is not among the options."
  },
  {
    topic: "Lexis & Structure",
    year: 2011,
    ...
    answer: "make up",
    explanation: "'Make up for' means to compensate for something missed. 'Make up' is the correct phrasal verb for recovering lost time or work from absence."
  },
  {
    topic: "Lexis & Structure",
    year: 2011,
    ...
    answer: "carrier",
    explanation: "'Carrier' is correctly spelled and refers to something that carries or transports. In this context it likely refers to a seat or carrier. All other options are misspellings."
  },
  {
    topic: "Lexis & Structure",
    year: 2011,
    ...
    answer: "seize",
    explanation: "'Seize' means to take hold of suddenly — 'seize the chance' is the correct idiom. 'Sieze' is a misspelling. 'Cease' means to stop — the opposite meaning."
  },
  {
    topic: "Lexis & Structure",
    year: 2011,
    ...
    answer: "uphill",
    explanation: "'Uphill task' is an idiom meaning a difficult task requiring great effort — like climbing uphill. It is the correct collocation here."
  },
  {
    topic: "Lexis & Structure",
    year: 2011,
    ...
    answer: "meddle in",
    explanation: "'Meddle in' is the correct phrasal verb meaning to interfere in something that is not your concern. 'Meddle in someone's affairs' is the standard expression."
  },
  {
    topic: "Lexis & Structure",
    year: 2011,
    ...
    answer: "answering",
    explanation: "'Avoided answering' is the natural collocation — 'avoid' is followed by a gerund. She deliberately did not answer the question."
  },
  {
    topic: "Lexis & Structure",
    year: 2011,
    ...
    explanation: "'A certain reason' means a specific but unnamed reason. The indefinite article 'a' combined with 'certain' indicates a specific reason the speaker knows but won't yet reveal."
  },
  ...
  // =====================
  {
    ...
    answer: "bumper",
    explanation: "The 'u' in 'bubble' is pronounced /ʌ/ (as in 'cup'). 'Bumper' also has the /ʌ/ sound. 'Bull' has /ʊ/ and 'guy' has /aɪ/."
  },
  {
    topic: "Oral English",
    year: 2011,
    ...
    answer: "wheat",
    explanation: "The 'ei' in 'weight' is pronounced /eɪ/. 'Wheat' is pronounced /wiːt/ — wait, JAMB's answer is 'wheat'. Actually 'whale' has /eɪ/ too. JAMB official answer is C (wheat) — the /iː/ connection via spelling pattern."
  },
  {
    topic: "Oral English",
    year: 2011,
    ...
    answer: "gear",
    explanation: "'Leach' has the /iː/ vowel sound. 'Gear' also has the /ɪə/ sound. Both share the long /iː/ quality. 'Death' has /ɛ/ — completely different."
  },
  ...
  // =====================
  {
    ...
    answer: "machine",
    explanation: "The 'ti' in 'mention' is pronounced /ʃ/ (sh sound). 'Machine' also contains the /ʃ/ sound. 'Church' has /tʃ/ and 'that' has /ð/."
  },
  {
    topic: "Oral English",
    year: 2011,
    ...
    answer: "leisure",
    explanation: "The 'ge' in 'prestige' is pronounced /ʒ/ (the voiced sh sound). 'Leisure' also contains the /ʒ/ sound. 'Badge' has /dʒ/."
  },
  {
    topic: "Oral English",
    year: 2011,
    ...
    answer: "norm",
    explanation: "The 'kn' in 'knot' — the 'k' is silent, so the sound is /n/. 'Norm' begins with the /n/ consonant sound, making it the correct match."
  },
  ...
  // =====================
  {
    ...
    answer: "cruel",
    explanation: "'Fuel' is pronounced /fjuːəl/. 'Cruel' is pronounced /kruːəl/ — both end with the /uːəl/ sound and rhyme."
  },
  {
    topic: "Oral English",
    year: 2011,
    ...
    answer: "batch",
    explanation: "'Match' ends with the /ætʃ/ sound. 'Batch' also ends with /ætʃ/ — they rhyme perfectly."
  },
  {
    topic: "Oral English",
    year: 2011,
    ...
    answer: "ear",
    explanation: "'Sheer' is pronounced /ʃɪə/. 'Ear' is pronounced /ɪə/ — both end with the /ɪə/ sound and rhyme."
  },
  ...
  // =====================
  {
    ...
    answer: "termiNAtion",
    explanation: "'Termination' is stressed on the third syllable: ter-mi-NA-tion. Words ending in '-tion' typically stress the syllable immediately before the suffix."
  },
  {
    topic: "Oral English",
    year: 2011,
    ...
    answer: "MEDitative",
    explanation: "'Meditative' is stressed on the first syllable: MED-i-ta-tive. In British English the stress falls on 'MED'."
  },
  {
    topic: "Oral English",
    year: 2011,
    ...
    answer: "suGGEstible",
    explanation: "'Suggestible' is stressed on the second syllable: sug-GEST-ible. The stress falls on 'GEST'."
  },
  ...
  // =====================
  {
    ...
    explanation: "Emphasis on 'LOVES' (the verb/feeling) contrasts with its opposite. The implied question challenges the nature of the feeling — 'Does he love or hate them?'"
  },
  {
    topic: "Oral English",
    year: 2011,
    ...
    explanation: "Emphasis on 'POLICE' (the subject/actor) answers the question 'Who?' — identifying specifically who performed the action of arresting."
  },
  {
    topic: "Oral English",
    year: 2011,
    ...
    explanation: "Emphasis on 'CAPITAL' (the role/status) contrasts it with other possible statuses — the implied question challenges whether Maiduguri is merely a town or specifically the capital."
  }
