...
const STEPS = [
  ...
  },
  {
    ...
    desc: "Start with a CBT test right now to get your baseline score. Then your AI Tutor will build you a personalised study plan. The exam is coming — let's go!",
    highlight: null,
    color: "#667eea",
    bg: "linear-gradient(135deg, #667eea, #764ba2)",
  },
